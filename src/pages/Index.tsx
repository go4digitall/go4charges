    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="pt-[46px] sm:pt-[64px]">
        ...
        <main className="flex-1">
          ...
          {/* Products Section */}
          <section id="products" className="py-12 md:py-16 bg-secondary scroll-mt-56 md:scroll-mt-36 relative overflow-hidden">
            <div className="container">
              <div className="text-center mb-10">
                ...
                <h2 className="text-3xl md:text-5xl font-bold mb-2 md:mb-4 text-foreground">
                  The <span className="text-primary">ChargeStand™</span>
                </h2>
              ...
              {isLoading ? (
                ...
                <div className="text-center py-12 text-destructive">Error loading product</div>
              ) : products && products.length > 0 ? (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto">
                  {(() => {
                    const singleProduct = products.find(p => {
                      const handle = p.node.handle.toLowerCase();
                      return !handle.includes('duo') && !handle.includes('2x') && !handle.includes('family') && !handle.includes('3x') && !handle.includes('famille') && !handle.includes('charger');
                    }) || products[0];
                    return <div className="w-full"><ProductCard product={singleProduct} isFeatured={false} /></div>;
                  })()}
                  <div className="w-full"><WallChargerCard /></div>
                </div>
              ) : (
              ...
              <div className="text-center mt-8">
                ...
                <a href="/product/chargestand-240w-90-fast-charging-cable?bundle=family" className="inline-flex items-center gap-2 text-primary hover:text-primary/80 font-semibold transition-colors">
