...
export const HeroSection = () => {
  ...
  return <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src={heroImage} alt="ChargeStand 240W Cable" className="w-full h-full object-cover" />
      ...
      <div className="relative z-10 container mx-auto px-4 py-16 md:py-28 lg:py-36">
        <div className="max-w-2xl">
          {/* Trust Badge */}
          <Badge variant="outline" className="mb-6 px-4 py-2 bg-background/80 backdrop-blur-sm border-emerald-200 text-emerald-700">Charge Faster. 
Play Longer.<div className="flex gap-0.5 mr-2">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            ...
            <Button size="lg" variant="outline" className="text-lg px-8 py-6 bg-background/80 backdrop-blur-sm hover:bg-background" onClick={scrollToProducts}>
              See Products
            </Button>
          </div>
