...
import { ShieldCheck, Truck, RotateCcw, Headphones, Star, CreditCard, ChevronDown, Loader2, Gift, Check, Zap } from "lucide-react";
            ...
            <div className="flex-1 w-full max-w-md lg:max-w-lg">
              <div className="relative">
                <div className="bg-card rounded-2xl border shadow-2xl overflow-hidden">
                  ...
                  />
                  {/* Mini review */}
                  <div className="flex items-start gap-3 bg-muted/50 rounded-b-2xl p-4">
