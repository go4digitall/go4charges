...
export const Header = () => {
  ...
  return (
    <header className="sticky top-[72px] sm:top-[52px] z-40 w-full border-b border-border/50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
